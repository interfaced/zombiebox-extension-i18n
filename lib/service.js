...
zb.i18n.Service.prototype._pluralize = function(locale, value, context) {
	...
	Object
		...
		.forEach(function(key) {
			...
			// TODO: number formatting should be done here instead
			var floatValue = '' + context[key];
			floatValue = floatValue.replace(/[^-+.\d]/g, '');
			floatValue = floatValue.match(/[\-\+]?\d*(\.\d+)?/);
			var count = floatValue ? parseFloat(floatValue[0]) : NaN;
