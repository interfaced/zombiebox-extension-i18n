...
export default class Plugin {
	 ...
	 * @param {CurrencySymbolType=} opt_symbolType
	 * @return {string}
	 */
	formatCurrency(value, currency, opt_fractional, opt_symbolType = CurrencySymbolType.NARROW) {
		const precision = opt_fractional ? 2 : 0;
		const isNarrow = opt_symbolType === CurrencySymbolType.NARROW;
